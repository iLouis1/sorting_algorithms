...
/**
 * bitonic_merge - This will sort bitonic sequence inside an array of integers.
 * @array: Array of integers.
 * @size: Size of array.
 * @start: Starting index of sequence in array to sort.
 * @seq: Size of sequence to be sorted.
...
/**
 * bitonic_sort - Will sort array of integers in ascending
