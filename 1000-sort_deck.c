...
/**
 * get_value - Will get numerical value of a card.
...
/**
 * insertion_sort_deck_kind - Will sort a deck of cards
...
/**
 * insertion_sort_deck_value - Will sort a deck of cards sorted from
...
/**
 * sort_deck - Will sort a deck of cards from ace to king and
 * from spades to diamonds.
 * @deck: The pointer to the head of a deck_node_t doubly-linked list.
 */
