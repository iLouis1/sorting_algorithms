...
/**
 * swap_node_ahead - WIll swap a node in a listint_t doubly-linked list
...
/**
 * swap_node_behind - Will swap nodes in a listint_t doubly-linked
 * list of integers with node behind it.
 * @list: Pointer to the head of a doubly-linked list of an integer.
 * @tail: Pointer to the tail of doubly-linked list.
...
/**
 * cocktail_sort_list - Will sort a listint_t doubly-linked list of integers in
